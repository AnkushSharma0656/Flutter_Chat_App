...
class UserModel{
  ...
  List<String> sendFriendRequests;
  ...
  UserModel({
    ...
    required this.sendFriendRequests
  });
  ...
  factory UserModel.fromMap(Map<String,dynamic>map){
    ...
    sendFriendRequests: List<String>.from(map[Constants.sendFriendRequests] ?? [])
    );
  }
  ...
  Map<String,dynamic> toMap(){
    return {
      ...
      Constants.sendFriendRequests : sendFriendRequests,
    };
